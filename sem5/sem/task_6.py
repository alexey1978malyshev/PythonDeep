...
def guess_result_dct(question, count):
    answer = 'в правде'
    tryies_count = 0
    while tryies_count < count:
        try_ans = input('введите ответ\n')
        if try_ans == answer:
            _dict[tryies_count+1] = 'вы угадали'
            return
        else:
            _dict[tryies_count+1] = 'не угадал'
            tryies_count+=1

guess_result_dct("В чем сила: ",3)
